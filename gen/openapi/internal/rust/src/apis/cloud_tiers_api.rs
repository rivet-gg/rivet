...
pub async fn cloud_tiers_get_region_tiers(configuration: &configuration::Configuration, ) -> Result<crate::models::CloudGetRegionTiersResponse, Error<CloudTiersGetRegionTiersError>> {
