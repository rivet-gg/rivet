...
pub async fn admin_login(configuration: &configuration::Configuration, admin_login_request: crate::models::AdminLoginRequest) -> Result<crate::models::AdminLoginResponse, Error<AdminLoginError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminLoginError> = serde_json::from_str(&local_var_content).ok();
