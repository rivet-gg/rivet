...
pub async fn auth_tokens_refresh_identity_token(configuration: &configuration::Configuration, auth_refresh_identity_token_request: crate::models::AuthRefreshIdentityTokenRequest) -> Result<crate::models::AuthRefreshIdentityTokenResponse, Error<AuthTokensRefreshIdentityTokenError>> {
