...
pub async fn chat_identity_get_direct_thread(configuration: &configuration::Configuration, identity_id: &str) -> Result<crate::models::ChatGetDirectThreadResponse, Error<ChatIdentityGetDirectThreadError>> {
