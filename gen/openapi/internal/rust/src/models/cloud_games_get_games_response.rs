...
impl CloudGamesGetGamesResponse {
    pub fn new(games: Vec<crate::models::CloudGamesGameSummary>, groups: Vec<crate::models::GroupHandle>, watch: crate::models::WatchResponse) -> CloudGamesGetGamesResponse {
