...
parsed_host=$(echo $RIVET_API_ENDPOINT | awk -F/ '{print $3}' | awk -F: '{print $1}')
parsed_port=$(echo $RIVET_API_ENDPOINT | awk -F/ '{print $3}' | awk -F: '{print $2}')
scheme=$(echo $RIVET_API_ENDPOINT | awk -F/ '{print $1}' | awk -F: '{print $1}')
