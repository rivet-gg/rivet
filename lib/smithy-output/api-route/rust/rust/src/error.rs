...
/// Error type for the `TraefikConfig` operation.
#[non_exhaustive]
#[derive(std::fmt::Debug)]
pub struct TraefikConfigError {
	/// Kind of error that occurred.
	pub kind: TraefikConfigErrorKind,
	/// Additional metadata about the error, including error code, message, and request ID.
	pub(crate) meta: aws_smithy_types::Error,
}
/// Types of errors that can occur for the `TraefikConfig` operation.
#[non_exhaustive]
#[derive(std::fmt::Debug)]
pub enum TraefikConfigErrorKind {
...
impl std::fmt::Display for TraefikConfigError {
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match &self.kind {
			TraefikConfigErrorKind::InternalError(_inner) => _inner.fmt(f),
			TraefikConfigErrorKind::RateLimitError(_inner) => _inner.fmt(f),
			TraefikConfigErrorKind::ForbiddenError(_inner) => _inner.fmt(f),
			TraefikConfigErrorKind::UnauthorizedError(_inner) => _inner.fmt(f),
			TraefikConfigErrorKind::NotFoundError(_inner) => _inner.fmt(f),
			TraefikConfigErrorKind::BadRequestError(_inner) => _inner.fmt(f),
			TraefikConfigErrorKind::Unhandled(_inner) => _inner.fmt(f),
		}
	}
}
impl aws_smithy_types::retry::ProvideErrorKind for TraefikConfigError {
	fn code(&self) -> Option<&str> {
		TraefikConfigError::code(self)
	}
	fn retryable_error_kind(&self) -> Option<aws_smithy_types::retry::ErrorKind> {
		match &self.kind {
			TraefikConfigErrorKind::InternalError(inner) => Some(inner.retryable_error_kind()),
			TraefikConfigErrorKind::UnauthorizedError(inner) => Some(inner.retryable_error_kind()),
			_ => None,
		}
	}
}
impl TraefikConfigError {
	/// Creates a new `TraefikConfigError`.
	pub fn new(kind: TraefikConfigErrorKind, meta: aws_smithy_types::Error) -> Self {
		Self { kind, meta }
	}

	/// Creates the `TraefikConfigError::Unhandled` variant from any error type.
	pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
		Self {
			kind: TraefikConfigErrorKind::Unhandled(err.into()),
			meta: Default::default(),
		}
	}

	/// Creates the `TraefikConfigError::Unhandled` variant from a `aws_smithy_types::Error`.
	...
	/// Returns `true` if the error kind is `TraefikConfigErrorKind::InternalError`.
	pub fn is_internal_error(&self) -> bool {
		matches!(&self.kind, TraefikConfigErrorKind::InternalError(_))
	}
	/// Returns `true` if the error kind is `TraefikConfigErrorKind::RateLimitError`.
	pub fn is_rate_limit_error(&self) -> bool {
		matches!(&self.kind, TraefikConfigErrorKind::RateLimitError(_))
	}
	/// Returns `true` if the error kind is `TraefikConfigErrorKind::ForbiddenError`.
	pub fn is_forbidden_error(&self) -> bool {
		matches!(&self.kind, TraefikConfigErrorKind::ForbiddenError(_))
	}
	/// Returns `true` if the error kind is `TraefikConfigErrorKind::UnauthorizedError`.
	pub fn is_unauthorized_error(&self) -> bool {
		matches!(&self.kind, TraefikConfigErrorKind::UnauthorizedError(_))
	}
	/// Returns `true` if the error kind is `TraefikConfigErrorKind::NotFoundError`.
	pub fn is_not_found_error(&self) -> bool {
		matches!(&self.kind, TraefikConfigErrorKind::NotFoundError(_))
	}
	/// Returns `true` if the error kind is `TraefikConfigErrorKind::BadRequestError`.
	pub fn is_bad_request_error(&self) -> bool {
		matches!(&self.kind, TraefikConfigErrorKind::BadRequestError(_))
	}
}
impl std::error::Error for TraefikConfigError {
	fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
		match &self.kind {
			TraefikConfigErrorKind::InternalError(_inner) => Some(_inner),
			TraefikConfigErrorKind::RateLimitError(_inner) => Some(_inner),
			TraefikConfigErrorKind::ForbiddenError(_inner) => Some(_inner),
			TraefikConfigErrorKind::UnauthorizedError(_inner) => Some(_inner),
			TraefikConfigErrorKind::NotFoundError(_inner) => Some(_inner),
			TraefikConfigErrorKind::BadRequestError(_inner) => Some(_inner),
			TraefikConfigErrorKind::Unhandled(_inner) => Some(_inner.as_ref()),
		}
	}
}
