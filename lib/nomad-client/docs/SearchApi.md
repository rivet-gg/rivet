...
> crate::models::FuzzySearchResponse get_fuzzy_search(fuzzy_search_request, region, namespace, index, wait, stale, prefix, x_nomad_token, per_page, next_token)
...
> crate::models::SearchResponse get_search(search_request, region, namespace, index, wait, stale, prefix, x_nomad_token, per_page, next_token)
