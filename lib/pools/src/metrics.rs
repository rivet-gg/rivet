...
lazy_static::lazy_static! {
	...
	// MARK: Cassandra
	pub static ref CASS_LATENCY_AVERAGE: GaugeVec = register_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_LATENCY_P95: GaugeVec = register_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_LATENCY_P99: GaugeVec = register_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_ERRORS_NUM: IntGaugeVec = register_int_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_QUERIES_NUM: IntGaugeVec = register_int_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_ERRORS_ITER_NUM: IntGaugeVec = register_int_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_QUERIES_ITER_NUM: IntGaugeVec = register_int_gauge_vec_with_registry!(
	...
	.unwrap();
	pub static ref CASS_RETRIES_NUM: IntGaugeVec = register_int_gauge_vec_with_registry!(
