...
function Id({ actorId }: { actorId: string }) {
	return (
		<SmallText>
			{actorId.includes("-")
				? actorId.split("-")[0]
...
function Region({ actorId }: { actorId: string }) {
...
function Tags({ actorId }: { actorId: string }) {
...
function CreatedAt({ actorId }: { actorId: string }) {
...
function DestroyedAt({ actorId }: { actorId: string }) {
