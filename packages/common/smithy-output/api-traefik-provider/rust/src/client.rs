...
/// An ergonomic service client for `RouteService`.
///
/// This client allows ergonomic access to a `RouteService`-shaped service.
...
///
/// ```
/// use rivet_route::{Builder, Client, Config};
/// let raw_client =
///     Builder::dyn_https()
/// #     /*
...
{
	/// Constructs a fluent builder for the [`TraefikConfig`](crate::client::fluent_builders::TraefikConfig) operation.
	///
	/// - The fluent builder is configurable:
	///   - [`token(impl Into<String>)`](crate::client::fluent_builders::TraefikConfig::token) / [`set_token(Option<String>)`](crate::client::fluent_builders::TraefikConfig::set_token): (undocumented)
	///   - [`pool(impl Into<String>)`](crate::client::fluent_builders::TraefikConfig::pool) / [`set_pool(Option<String>)`](crate::client::fluent_builders::TraefikConfig::set_pool): (undocumented)
	///   - [`region(impl Into<String>)`](crate::client::fluent_builders::TraefikConfig::region) / [`set_region(Option<String>)`](crate::client::fluent_builders::TraefikConfig::set_region): (undocumented)
	/// - On success, responds with [`TraefikConfigOutput`](crate::output::TraefikConfigOutput) with field(s):
	///   - [`http(Option<TraefikHttpNullified>)`](crate::output::TraefikConfigOutput::http): (undocumented)
	/// - On failure, responds with [`SdkError<TraefikConfigError>`](crate::error::TraefikConfigError)
	pub fn traefik_config(&self) -> fluent_builders::TraefikConfig<C, M, R> {
		fluent_builders::TraefikConfig::new(self.handle.clone())
	}
}
pub mod fluent_builders {
	...
	//!
	/// Fluent builder constructing a request to `TraefikConfig`.
	///
	/// Returns the current routing Traefik configuration.
	#[derive(std::clone::Clone, std::fmt::Debug)]
	pub struct TraefikConfig<C, M, R = aws_smithy_client::retry::Standard> {
		handle: std::sync::Arc<super::Handle<C, M, R>>,
		inner: crate::input::traefik_config_input::Builder,
	}
	impl<C, M, R> TraefikConfig<C, M, R>
	where
		C: aws_smithy_client::bounds::SmithyConnector,
		M: aws_smithy_client::bounds::SmithyMiddleware<C>,
		R: aws_smithy_client::retry::NewRequestPolicy,
	{
		/// Creates a new `TraefikConfig`.
		...
		pub async fn send(
			...
			crate::output::TraefikConfigOutput,
			aws_smithy_http::result::SdkError<crate::error::TraefikConfigError>,
		>
		where
			R::Policy: aws_smithy_client::bounds::SmithyRetryPolicy<
				crate::input::TraefikConfigInputOperationOutputAlias,
				crate::output::TraefikConfigOutput,
				crate::error::TraefikConfigError,
				crate::input::TraefikConfigInputOperationRetryAlias,
			>,
		{
			let op = self
				.inner
		...
		pub fn pool(mut self, input: impl Into<std::string::String>) -> Self {
			self.inner = self.inner.pool(input.into());
			self
		}
		#[allow(missing_docs)] // documentation missing in model
		pub fn set_pool(mut self, input: std::option::Option<std::string::String>) -> Self {
			self.inner = self.inner.set_pool(input);
			self
		}
		#[allow(missing_docs)] // documentation missing in model
