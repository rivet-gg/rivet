...
/// An ergonomic service client for `StatusService`.
///
/// This client allows ergonomic access to a `StatusService`-shaped service.
...
///
/// ```
/// use rivet_status::{Builder, Client, Config};
/// let raw_client =
///     Builder::dyn_https()
/// #     /*
...
{
	/// Constructs a fluent builder for the [`Matchmaker`](crate::client::fluent_builders::Matchmaker) operation.
	///
	/// - The fluent builder is configurable:
	///   - [`region(impl Into<String>)`](crate::client::fluent_builders::Matchmaker::region) / [`set_region(Option<String>)`](crate::client::fluent_builders::Matchmaker::set_region): (undocumented)
	/// - On success, responds with [`MatchmakerOutput`](crate::output::MatchmakerOutput)

	/// - On failure, responds with [`SdkError<MatchmakerError>`](crate::error::MatchmakerError)
	pub fn matchmaker(&self) -> fluent_builders::Matchmaker<C, M, R> {
		fluent_builders::Matchmaker::new(self.handle.clone())
	}
}
pub mod fluent_builders {
	...
	//!
	/// Fluent builder constructing a request to `Matchmaker`.
	///
	/// Returns the resolved matchmaker region.
	#[derive(std::clone::Clone, std::fmt::Debug)]
	pub struct Matchmaker<C, M, R = aws_smithy_client::retry::Standard> {
		handle: std::sync::Arc<super::Handle<C, M, R>>,
		inner: crate::input::matchmaker_input::Builder,
	}
	impl<C, M, R> Matchmaker<C, M, R>
	where
		C: aws_smithy_client::bounds::SmithyConnector,
		M: aws_smithy_client::bounds::SmithyMiddleware<C>,
		R: aws_smithy_client::retry::NewRequestPolicy,
	{
		...
		pub async fn send(
			...
			aws_smithy_http::result::SdkError<crate::error::MatchmakerError>,
		>
		where
			R::Policy: aws_smithy_client::bounds::SmithyRetryPolicy<
				crate::input::MatchmakerInputOperationOutputAlias,
				crate::output::MatchmakerOutput,
				crate::error::MatchmakerError,
				crate::input::MatchmakerInputOperationRetryAlias,
			>,
		{
			let op = self
				.inner
