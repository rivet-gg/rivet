...
impl<R> From<aws_smithy_http::result::SdkError<crate::error::MatchmakerError, R>> for Error
where
	R: Send + Sync + std::fmt::Debug + 'static,
{
	fn from(err: aws_smithy_http::result::SdkError<crate::error::MatchmakerError, R>) -> Self {
		match err {
			aws_smithy_http::result::SdkError::ServiceError { err, .. } => match err.kind {
				crate::error::MatchmakerErrorKind::InternalError(inner) => {
					Error::InternalError(inner)
				}
				crate::error::MatchmakerErrorKind::RateLimitError(inner) => {
					Error::RateLimitError(inner)
				}
				crate::error::MatchmakerErrorKind::ForbiddenError(inner) => {
					Error::ForbiddenError(inner)
				}
				crate::error::MatchmakerErrorKind::UnauthorizedError(inner) => {
					Error::UnauthorizedError(inner)
				}
				crate::error::MatchmakerErrorKind::NotFoundError(inner) => {
					Error::NotFoundError(inner)
				}
				crate::error::MatchmakerErrorKind::BadRequestError(inner) => {
					Error::BadRequestError(inner)
				}
				crate::error::MatchmakerErrorKind::Unhandled(inner) => Error::Unhandled(inner),
			},
