...
// 	// let stream_type = backend::ds::log::StreamType::StdOut;

// 	// // Insert entries
// 	// let entries = (0..TS_COUNT)
// 	// 	.flat_map(|i| backend::ds::log::LogEntry {
// 	// 		ts: now + (i as i64 * MESSAGE_INTERVAL),
// 	// 		message: format!("Hello, {i}!").into_bytes(),
// 	// 	})
// 	// 	.collect::<Vec<_>>();
// 	// msg!([ctx] ds_log::msg::entries(&run_id, "stdout") {
...
// 	// // Before ts
// 	// {
// 	// 	let res = op!([ctx] ds_log_read {
// 	// 		run_id: Some(run_id.into()),
// 	// 		stream_type: stream_type as i32,
// 	// 		count: 128,
// 	// 		query: Some(ds_log::read::request::Query::BeforeTs(ts: now + 5 * MESSAGE_INTERVAL)),
// 	// 	})
// 	// 	.await
// 	// 	.unwrap();
...
// 	// 		stream_type: stream_type as i32,
// 	// 		count: 128,
// 	// 		query: Some(ds_log::read::request::Query::AfterTs(now + 7 * MESSAGE_INTERVAL)),
// 	// 	})
// 	// 	.await
// 	// 	.unwrap();
...
// 	// 		stream_type: stream_type as i32,
// 	// 		count: 128,
// 	// 		query: Some(ds_log::read::request::Query::All(())),
// 	// 	})
// 	// 	.await
// 	// 	.unwrap();
