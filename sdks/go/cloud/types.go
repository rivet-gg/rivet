...
type GroupBillingInvoice struct {
...
func (g *GroupBillingInvoice) UnmarshalJSON(data []byte) error {
	type unmarshaler GroupBillingInvoice
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*g = GroupBillingInvoice(value)
	g._rawJSON = json.RawMessage(data)
	return nil
}

func (g *GroupBillingInvoice) String() string {
	if len(g._rawJSON) > 0 {
		if value, err := core.StringifyJSON(g._rawJSON); err == nil {
			return value
		}
...
type GroupBillingPayment struct {
	...
	FromInvoice bool `json:"from_invoice"`
	// RFC3339 timestamp.
	CreatedTs time.Time          `json:"created_ts"`
	Status    GroupBillingStatus `json:"status,omitempty"`

	_rawJSON json.RawMessage
}

func (g *GroupBillingPayment) UnmarshalJSON(data []byte) error {
	type unmarshaler GroupBillingPayment
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*g = GroupBillingPayment(value)
	g._rawJSON = json.RawMessage(data)
	return nil
}

func (g *GroupBillingPayment) String() string {
	if len(g._rawJSON) > 0 {
		if value, err := core.StringifyJSON(g._rawJSON); err == nil {
			return value
		}
...
type GroupBillingStatus string

const (
	GroupBillingStatusSucceeded  GroupBillingStatus = "succeeded"
	GroupBillingStatusProcessing GroupBillingStatus = "processing"
	GroupBillingStatusRefunded   GroupBillingStatus = "refunded"
)

func NewGroupBillingStatusFromString(s string) (GroupBillingStatus, error) {
	switch s {
	case "succeeded":
		return GroupBillingStatusSucceeded, nil
	case "processing":
		return GroupBillingStatusProcessing, nil
	case "refunded":
		return GroupBillingStatusRefunded, nil
	}
	var t GroupBillingStatus
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (g GroupBillingStatus) Ptr() *GroupBillingStatus {
	return &g
}

// A group billing summary.
type GroupBillingSummary struct {
	// A list of multiple game lobby expenses.
	Games []*GameLobbyExpenses `json:"games,omitempty"`
...
func (g *GroupBillingSummary) UnmarshalJSON(data []byte) error {
	type unmarshaler GroupBillingSummary
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*g = GroupBillingSummary(value)
	g._rawJSON = json.RawMessage(data)
	return nil
}

func (g *GroupBillingSummary) String() string {
	if len(g._rawJSON) > 0 {
		if value, err := core.StringifyJSON(g._rawJSON); err == nil {
			return value
		}
...
type GroupBillingTransfer struct {
	// Payment amount (in hundredths USD, 100 = $1.00).
...
func (g *GroupBillingTransfer) UnmarshalJSON(data []byte) error {
	type unmarshaler GroupBillingTransfer
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*g = GroupBillingTransfer(value)
	g._rawJSON = json.RawMessage(data)
	return nil
}

func (g *GroupBillingTransfer) String() string {
	if len(g._rawJSON) > 0 {
		if value, err := core.StringifyJSON(g._rawJSON); err == nil {
			return value
		}
