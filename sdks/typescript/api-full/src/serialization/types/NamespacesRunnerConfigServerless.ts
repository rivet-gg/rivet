...
export const NamespacesRunnerConfigServerless: core.serialization.ObjectSchema<
    serializers.NamespacesRunnerConfigServerless.Raw,
    Rivet.NamespacesRunnerConfigServerless
