...
func (c *Client) Upgrade(ctx context.Context, actor uuid.UUID, request *sdkactor.UpgradeActorRequestQuery) (*sdkactor.UpgradeActorResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *sdkactor.UpgradeActorResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
...
// Upgrades a dynamic actor.
func (c *Client) UpgradeAll(ctx context.Context, request *sdkactor.UpgradeAllActorsRequestQuery) (*sdkactor.UpgradeAllActorsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *sdkactor.UpgradeAllActorsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
