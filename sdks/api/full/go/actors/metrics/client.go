...
func (c *Client) Get(ctx context.Context, actor uuid.UUID, request *actors.GetActorMetricsRequestQuery) (*actors.GetActorMetricsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := fmt.Sprintf(baseURL+"/"+"actors/%v/metrics/history", actor)
