...
import (
	...
	sdk "sdk"
	v1 "sdk/actors/v1"
	logs "sdk/actors/v1/logs"
	metrics "sdk/actors/v1/metrics"
	core "sdk/core"
)
...
func (c *Client) Get(ctx context.Context, actor uuid.UUID, request *v1.ListActorsRequestQuery) (*v1.GetActorResponse, error) {
	...
	var response *v1.GetActorResponse
...
func (c *Client) List(ctx context.Context, request *v1.GetActorsRequestQuery) (*v1.ListActorsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *v1.ListActorsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
...
// Create a new actor.
func (c *Client) Create(ctx context.Context, request *v1.CreateActorRequestQuery) (*v1.CreateActorResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *v1.CreateActorResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
...
//
// The id of the actor to destroy
func (c *Client) Destroy(ctx context.Context, actor uuid.UUID, request *v1.DestroyActorRequestQuery) (*v1.DestroyActorResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *v1.DestroyActorResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
...
func (c *Client) Upgrade(ctx context.Context, actor uuid.UUID, request *v1.UpgradeActorRequestQuery) (*v1.UpgradeActorResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *v1.UpgradeActorResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
...
func (c *Client) UpgradeAll(ctx context.Context, request *v1.UpgradeAllActorsRequestQuery) (*v1.UpgradeAllActorsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	...
	var response *v1.UpgradeAllActorsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
