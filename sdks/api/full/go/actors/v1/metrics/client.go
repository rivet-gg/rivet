...
func (c *Client) Get(ctx context.Context, actor uuid.UUID, request *v1.GetActorMetricsRequestQuery) (*v1.GetActorMetricsResponse, error) {
	...
	var response *v1.GetActorMetricsResponse
