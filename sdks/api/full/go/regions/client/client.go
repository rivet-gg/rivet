...
func (c *Client) List(ctx context.Context, request *regions.ListRegionsRequestQuery) (*regions.ListRegionsResponse, error) {
	...
	var response *regions.ListRegionsResponse
...
func (c *Client) Recommend(ctx context.Context, request *regions.RecommendRegionsRequestQuery) (*regions.RecommendRegionResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "regions/recommend"
	...
	var response *regions.RecommendRegionResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:          endpointURL,
