...
func (c *Client) GetTls(ctx context.Context) (*tunnel.GetTlsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "tunnel/tls"
	...
	var response *tunnel.GetTlsResponse
