...
func (c *Client) Complete(ctx context.Context, request *devices.CompleteDeviceLinkRequest) error {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "cloud/devices/links/complete"
