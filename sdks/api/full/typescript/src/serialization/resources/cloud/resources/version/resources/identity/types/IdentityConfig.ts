...
export const IdentityConfig: core.serialization.ObjectSchema<
    serializers.cloud.version.identity.IdentityConfig.Raw,
    Rivet.cloud.version.identity.IdentityConfig
