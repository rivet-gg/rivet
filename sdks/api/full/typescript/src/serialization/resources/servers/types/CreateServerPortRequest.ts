...
export const CreateServerPortRequest: core.serialization.ObjectSchema<
    serializers.servers.CreateServerPortRequest.Raw,
    Rivet.servers.CreateServerPortRequest
...
export declare namespace CreateServerPortRequest {
