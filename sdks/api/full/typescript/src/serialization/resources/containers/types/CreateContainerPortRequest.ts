...
export const CreateContainerPortRequest: core.serialization.ObjectSchema<
    serializers.containers.CreateContainerPortRequest.Raw,
    Rivet.containers.CreateContainerPortRequest
...
export declare namespace CreateContainerPortRequest {
