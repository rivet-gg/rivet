...
export class Activities {
    ...
    public async list(
        ...
        if (_response.ok) {
            return serializers.identity.ListActivitiesResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /identity/activities.");
            case "unknown":
                throw new errors.RivetError({
