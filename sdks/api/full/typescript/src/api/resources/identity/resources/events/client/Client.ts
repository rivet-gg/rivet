...
export class Events {
     ...
     *
     * @param {RivetClient.identity.WatchEventsRequest} request
     ...
     */
    public async watch(
        request: RivetClient.identity.WatchEventsRequest = {},
        requestOptions?: Events.RequestOptions
    ): Promise<RivetClient.identity.WatchEventsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /identity/events/live.");
            case "unknown":
                throw new errors.RivetClientError({
