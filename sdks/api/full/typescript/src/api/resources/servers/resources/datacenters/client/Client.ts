...
export class Datacenters {
    ...
    public async list(
    ...
    ): Promise<Rivet.servers.ListDatacentersResponse> {
        ...
        if (_response.ok) {
            return serializers.servers.ListDatacentersResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError(
                    "Timeout exceeded when calling GET /games/{game_id}/environments/{environment_id}/datacenters."
                );
            case "unknown":
                throw new errors.RivetError({
