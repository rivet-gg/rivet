...
export class Logs {
     ...
     * @param {RivetClient.servers.GetServerLogsRequest} request
    ...
    public async get(
        ...
        serverId: string,
        request: RivetClient.servers.GetServerLogsRequest,
        requestOptions?: Logs.RequestOptions
    ): Promise<RivetClient.servers.GetServerLogsResponse> {
