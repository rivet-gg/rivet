...
export class Builds {
    ...
    ): Promise<RivetClient.cloud.games.ListGameBuildsResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError(
                    "Timeout exceeded when calling GET /cloud/games/{game_id}/builds."
                );
            case "unknown":
                throw new errors.RivetClientError({
    ...
    public async createGameBuild(
        gameId: string,
        request: RivetClient.cloud.games.CreateGameBuildRequest,
        requestOptions?: Builds.RequestOptions
    ): Promise<RivetClient.cloud.games.CreateGameBuildResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetClientEnvironment.Production,
                `/cloud/games/${encodeURIComponent(gameId)}/builds`
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError(
                    "Timeout exceeded when calling POST /cloud/games/{game_id}/builds."
                );
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
