...
export class Builds {
    ...
    public async listGameBuilds(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /cloud/games/{game_id}/builds.");
            case "unknown":
                throw new errors.RivetError({
    ...
    public async createGameBuild(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling POST /cloud/games/{game_id}/builds.");
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
                });
