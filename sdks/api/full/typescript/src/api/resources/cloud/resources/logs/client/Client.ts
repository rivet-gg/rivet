    ...
    public async getRayPerfLogs(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                ...
                `/cloud/rays/${encodeURIComponent(rayId)}/perf`
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return serializers.cloud.GetRayPerfLogsResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /cloud/rays/{ray_id}/perf.");
            case "unknown":
                throw new errors.RivetError({
