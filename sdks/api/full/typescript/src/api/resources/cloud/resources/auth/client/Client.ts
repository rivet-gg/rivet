...
export class Auth {
    ...
    public async inspect(requestOptions?: Auth.RequestOptions): Promise<Rivet.cloud.InspectResponse> {
        ...
        if (_response.ok) {
            return serializers.cloud.InspectResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /cloud/auth/inspect.");
            case "unknown":
                throw new errors.RivetError({
