...
export class Games {
    ...
    public async getGames(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /cloud/games.");
            case "unknown":
                throw new errors.RivetClientError({
    ...
    public async createGame(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling POST /cloud/games.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
    ...
    public async validateGame(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling POST /cloud/games/validate.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
    ...
    public async getGameById(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /cloud/games/{game_id}.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
