...
export class Games {
    ...
    public async getGames(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /cloud/games.");
            case "unknown":
                throw new errors.RivetError({
    ...
    public async createGame(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling POST /cloud/games.");
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
                });
    ...
    public async validateGame(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling POST /cloud/games/validate.");
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
                });
    ...
    public async getGameById(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /cloud/games/{game_id}.");
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
                });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError(
                    "Timeout exceeded when calling POST /cloud/games/{game_id}/banner-upload/prepare."
                );
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
    ...
    public async gameBannerUploadComplete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError(
                    "Timeout exceeded when calling POST /cloud/games/{game_id}/banner-upload/{upload_id}/complete."
                );
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
    ...
    public async gameLogoUploadPrepare(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError(
                    "Timeout exceeded when calling POST /cloud/games/{game_id}/logo-upload/prepare."
                );
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
    ...
    public async gameLogoUploadComplete(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError(
                    "Timeout exceeded when calling POST /cloud/games/{game_id}/logo-upload/{upload_id}/complete."
                );
            case "unknown":
                throw new errors.RivetError({
                    message: _response.error.errorMessage,
