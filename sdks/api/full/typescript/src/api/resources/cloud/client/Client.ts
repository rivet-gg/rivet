...
export class Cloud {
     ...
     */
    public async bootstrap(requestOptions?: Cloud.RequestOptions): Promise<RivetClient.cloud.BootstrapResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /cloud/bootstrap.");
            case "unknown":
                throw new errors.RivetClientError({
