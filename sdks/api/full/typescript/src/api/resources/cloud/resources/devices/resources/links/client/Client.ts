...
export class Links {
    ...
    public async prepare(
    ...
    ): Promise<RivetClient.cloud.devices.PrepareDeviceLinkResponse> {
        ...
        if (_response.ok) {
            return serializers.cloud.devices.PrepareDeviceLinkResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling POST /cloud/devices/links.");
            case "unknown":
                throw new errors.RivetClientError({
    ...
    /**
     * @param {RivetClient.cloud.devices.GetDeviceLinkRequest} request
     * @param {Links.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link RivetClient.InternalError}
     * @throws {@link RivetClient.RateLimitError}
     ...
     */
    public async get(
        request: RivetClient.cloud.devices.GetDeviceLinkRequest,
        requestOptions?: Links.RequestOptions
    ): Promise<RivetClient.cloud.devices.GetDeviceLinkResponse> {
        ...
        if (_response.ok) {
            return serializers.cloud.devices.GetDeviceLinkResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /cloud/devices/links.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
    ...
    /**
     * @param {RivetClient.cloud.devices.CompleteDeviceLinkRequest} request
     * @param {Links.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link RivetClient.InternalError}
     * @throws {@link RivetClient.RateLimitError}
    ...
    public async complete(
        request: RivetClient.cloud.devices.CompleteDeviceLinkRequest,
        requestOptions?: Links.RequestOptions
    ): Promise<void> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.cloud.devices.CompleteDeviceLinkRequest.jsonOrThrow(request, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError(
                    "Timeout exceeded when calling POST /cloud/devices/links/complete."
                );
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
