...
export class Logs {
     ...
     *
     * @param {Rivet.actors.v1.GetActorLogsRequestQuery} request
     ...
     *
     * @example
     *     await client.actors.v1.logs.get({
     *         project: "string",
     *         environment: "string",
     *         stream: "std_out",
     *         actorIdsJson: "string",
     ...
     */
    public async get(
        request: Rivet.actors.v1.GetActorLogsRequestQuery,
        requestOptions?: Logs.RequestOptions,
    ): Promise<Rivet.actors.v1.GetActorLogsResponse> {
        const {
            project,
            environment,
            stream,
        ...
        _queryParams["stream"] = serializers.actors.v1.QueryLogStream.jsonOrThrow(stream, {
        ...
        if (_response.ok) {
            return serializers.actors.v1.GetActorLogsResponse.parseOrThrow(_response.body, {
