...
export class Metrics {
     ...
     *
     * @example
     *     await client.actors.metrics.get({
     *         project: "string",
     *         environment: "string",
     *         start: 1,
     *         end: 1,
    ...
    public async get(
        ...
        const { project, environment, start, end, interval, actorIdsJson, metricsJson } = request;
        ...
        _queryParams["metrics_json"] = metricsJson;
        ...
        if (_response.ok) {
            return serializers.actors.GetActorMetricsResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /actors/metrics/history.");
            case "unknown":
                throw new errors.RivetError({
