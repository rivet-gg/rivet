...
export class Email {
     ...
     *
     * @param {RivetClient.auth.identity.StartEmailVerificationRequest} request
    ...
    public async startEmailVerification(
        request: RivetClient.auth.identity.StartEmailVerificationRequest,
        requestOptions?: Email.RequestOptions
    ): Promise<RivetClient.auth.identity.StartEmailVerificationResponse> {
     ...
     *
     * @param {RivetClient.auth.identity.CompleteEmailVerificationRequest} request
     * @param {Email.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link RivetClient.InternalError}
     * @throws {@link RivetClient.RateLimitError}
    ...
    public async completeEmailVerification(
        request: RivetClient.auth.identity.CompleteEmailVerificationRequest,
        requestOptions?: Email.RequestOptions
    ): Promise<RivetClient.auth.identity.CompleteEmailVerificationResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetClientEnvironment.Production,
