...
export class Regions {
     ...
     */
    public async list(requestOptions?: Regions.RequestOptions): Promise<RivetClient.matchmaker.ListRegionsResponse> {
        ...
        if (_response.ok) {
            return serializers.matchmaker.ListRegionsResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /matchmaker/regions.");
            case "unknown":
                throw new errors.RivetClientError({
