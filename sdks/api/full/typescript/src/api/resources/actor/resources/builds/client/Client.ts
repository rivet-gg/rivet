...
export class Builds {
    ...
    public async get(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /builds/{build}.");
            case "unknown":
                throw new errors.RivetClientError({
    ...
    public async list(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling GET /builds.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
    ...
    public async patchTags(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling PATCH /builds/{build}/tags.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
    ...
    public async prepare(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError("Timeout exceeded when calling POST /builds/prepare.");
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
                });
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetClientTimeoutError(
                    "Timeout exceeded when calling POST /builds/{build}/complete."
                );
            case "unknown":
                throw new errors.RivetClientError({
                    message: _response.error.errorMessage,
