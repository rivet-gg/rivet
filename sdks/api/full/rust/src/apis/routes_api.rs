...
pub async fn routes_delete(
...
) -> Result<serde_json::Value, Error<RoutesDeleteError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<RoutesDeleteError> =
...
pub async fn routes_history(
	...
	group_by: Option<&str>,
) -> Result<crate::models::RoutesHistoryResponse, Error<RoutesHistoryError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<RoutesHistoryError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn routes_list(
	configuration: &configuration::Configuration,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<crate::models::RoutesListRoutesResponse, Error<RoutesListError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<RoutesListError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn routes_update(
	configuration: &configuration::Configuration,
	id: &str,
	routes_update_route_body: crate::models::RoutesUpdateRouteBody,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<serde_json::Value, Error<RoutesUpdateError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<RoutesUpdateError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
