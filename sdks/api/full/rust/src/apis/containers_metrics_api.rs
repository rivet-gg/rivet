...
pub async fn containers_metrics_get(
...
) -> Result<crate::models::ContainersGetContainerMetricsResponse, Error<ContainersMetricsGetError>>
{
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersMetricsGetError> =
