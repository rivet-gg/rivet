...
pub async fn matchmaker_players_connected(configuration: &configuration::Configuration, matchmaker_players_connected_request: crate::models::MatchmakerPlayersConnectedRequest) -> Result<(), Error<MatchmakerPlayersConnectedError>> {
    ...
    let local_var_uri_str = format!("{}/matchmaker/players/connected", local_var_configuration.base_path);
...
pub async fn matchmaker_players_disconnected(configuration: &configuration::Configuration, matchmaker_players_connected_request: crate::models::MatchmakerPlayersConnectedRequest) -> Result<(), Error<MatchmakerPlayersDisconnectedError>> {
    ...
    let local_var_uri_str = format!("{}/matchmaker/players/disconnected", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn matchmaker_players_get_statistics(configuration: &configuration::Configuration, ) -> Result<crate::models::MatchmakerGetStatisticsResponse, Error<MatchmakerPlayersGetStatisticsError>> {
    ...
    let local_var_uri_str = format!("{}/matchmaker/players/statistics", local_var_configuration.base_path);
