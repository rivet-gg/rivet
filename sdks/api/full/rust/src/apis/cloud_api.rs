...
pub async fn cloud_bootstrap(configuration: &configuration::Configuration, ) -> Result<crate::models::CloudBootstrapResponse, Error<CloudBootstrapError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CloudBootstrapError> = serde_json::from_str(&local_var_content).ok();
