...
pub async fn identity_activities_list(
	configuration: &configuration::Configuration,
	watch_index: Option<&str>,
) -> Result<crate::models::IdentityListActivitiesResponse, Error<IdentityActivitiesListError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityActivitiesListError> =
