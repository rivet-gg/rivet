...
pub async fn containers_create(
	...
	containers_create_container_request: crate::models::ContainersCreateContainerRequest,
	project: Option<&str>,
	environment: Option<&str>,
	endpoint_type: Option<crate::models::ContainersEndpointType>,
) -> Result<crate::models::ContainersCreateContainerResponse, Error<ContainersCreateError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersCreateError> =
...
pub async fn containers_destroy(
...
) -> Result<serde_json::Value, Error<ContainersDestroyError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersDestroyError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn containers_get(
	...
	environment: Option<&str>,
	endpoint_type: Option<crate::models::ContainersEndpointType>,
) -> Result<crate::models::ContainersGetContainerResponse, Error<ContainersGetError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersGetError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn containers_list(
	...
	cursor: Option<&str>,
) -> Result<crate::models::ContainersListContainersResponse, Error<ContainersListError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersListError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn containers_upgrade(
	configuration: &configuration::Configuration,
	container: &str,
	containers_upgrade_container_request: crate::models::ContainersUpgradeContainerRequest,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<serde_json::Value, Error<ContainersUpgradeError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersUpgradeError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn containers_upgrade_all(
	configuration: &configuration::Configuration,
	containers_upgrade_all_containers_request: crate::models::ContainersUpgradeAllContainersRequest,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<crate::models::ContainersUpgradeAllContainersResponse, Error<ContainersUpgradeAllError>>
{
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersUpgradeAllError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
