...
pub async fn group_invites_consume_invite(
	configuration: &configuration::Configuration,
	group_invite_code: &str,
) -> Result<crate::models::GroupConsumeInviteResponse, Error<GroupInvitesConsumeInviteError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupInvitesConsumeInviteError> =
...
pub async fn group_invites_create_invite(
	configuration: &configuration::Configuration,
	group_id: &str,
	group_create_invite_request: crate::models::GroupCreateInviteRequest,
) -> Result<crate::models::GroupCreateInviteResponse, Error<GroupInvitesCreateInviteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupInvitesCreateInviteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_invites_get_invite(
	configuration: &configuration::Configuration,
	group_invite_code: &str,
) -> Result<crate::models::GroupGetInviteResponse, Error<GroupInvitesGetInviteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupInvitesGetInviteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
