...
pub async fn actors_metrics_get(
...
) -> Result<crate::models::ActorsGetActorMetricsResponse, Error<ActorsMetricsGetError>> {
	...
	local_var_req_builder =
		local_var_req_builder.query(&[("metrics_json", &metrics_json.to_string())]);
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ActorsMetricsGetError> =
