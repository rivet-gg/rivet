...
pub async fn builds_complete(
	configuration: &configuration::Configuration,
	build: &str,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<(), Error<BuildsCompleteError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<BuildsCompleteError> =
...
/// Get a build.
pub async fn builds_get(
	configuration: &configuration::Configuration,
	build: &str,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<crate::models::BuildsGetBuildResponse, Error<BuildsGetError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<BuildsGetError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn builds_list(
...
) -> Result<crate::models::BuildsListBuildsResponse, Error<BuildsListError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<BuildsListError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn builds_patch_tags(
	configuration: &configuration::Configuration,
	build: &str,
	builds_patch_build_tags_request: crate::models::BuildsPatchBuildTagsRequest,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<serde_json::Value, Error<BuildsPatchTagsError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<BuildsPatchTagsError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn builds_prepare(
	configuration: &configuration::Configuration,
	builds_prepare_build_request: crate::models::BuildsPrepareBuildRequest,
	project: Option<&str>,
	environment: Option<&str>,
) -> Result<crate::models::BuildsPrepareBuildResponse, Error<BuildsPrepareError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<BuildsPrepareError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
