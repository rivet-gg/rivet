...
/// struct for typed errors of method [`actors_v1_logs_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorsV1LogsGetError {
...
pub async fn actors_v1_logs_get(
	configuration: &configuration::Configuration,
	stream: crate::models::ActorsV1QueryLogStream,
	actor_ids_json: &str,
	project: Option<&str>,
...
) -> Result<crate::models::ActorsV1GetActorLogsResponse, Error<ActorsV1LogsGetError>> {
	...
	local_var_req_builder =
		local_var_req_builder.query(&[("actor_ids_json", &actor_ids_json.to_string())]);
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ActorsV1LogsGetError> =
