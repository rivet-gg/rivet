...
pub async fn containers_logs_get(
	configuration: &configuration::Configuration,
	stream: crate::models::ContainersQueryLogStream,
...
) -> Result<crate::models::ContainersGetContainerLogsResponse, Error<ContainersLogsGetError>> {
	...
	local_var_req_builder =
		local_var_req_builder.query(&[("container_ids_json", &container_ids_json.to_string())]);
	...
	if let Some(ref local_var_str) = search_case_sensitive {
		local_var_req_builder =
			local_var_req_builder.query(&[("search_case_sensitive", &local_var_str.to_string())]);
	}
	if let Some(ref local_var_str) = search_enable_regex {
		local_var_req_builder =
			local_var_req_builder.query(&[("search_enable_regex", &local_var_str.to_string())]);
	}
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ContainersLogsGetError> =
