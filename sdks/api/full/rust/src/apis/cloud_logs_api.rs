...
pub async fn cloud_logs_get_ray_perf_logs(
	configuration: &configuration::Configuration,
	ray_id: &str,
) -> Result<crate::models::CloudGetRayPerfLogsResponse, Error<CloudLogsGetRayPerfLogsError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudLogsGetRayPerfLogsError> =
