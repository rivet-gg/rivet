...
pub async fn identity_events_watch(
	configuration: &configuration::Configuration,
	watch_index: Option<&str>,
) -> Result<crate::models::IdentityWatchEventsResponse, Error<IdentityEventsWatchError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityEventsWatchError> =
