...
pub async fn actors_logs_export(
	configuration: &configuration::Configuration,
	actors_logs_export_request: crate::models::ActorsLogsExportRequest,
) -> Result<crate::models::ActorsExportActorLogsResponse, Error<ActorsLogsExportError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ActorsLogsExportError> =
...
pub async fn actors_logs_get(
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ActorsLogsGetError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
