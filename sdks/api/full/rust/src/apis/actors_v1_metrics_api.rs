...
/// struct for typed errors of method [`actors_v1_metrics_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorsV1MetricsGetError {
...
pub async fn actors_v1_metrics_get(
...
) -> Result<crate::models::ActorsV1GetActorMetricsResponse, Error<ActorsV1MetricsGetError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ActorsV1MetricsGetError> =
