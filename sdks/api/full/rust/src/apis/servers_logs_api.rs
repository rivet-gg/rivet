...
pub async fn servers_logs_get(
	configuration: &configuration::Configuration,
	game_id: &str,
	environment_id: &str,
	server_id: &str,
	stream: crate::models::ServersLogStream,
	watch_index: Option<&str>,
) -> Result<crate::models::ServersGetServerLogsResponse, Error<ServersLogsGetError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/games/{game_id}/environments/{environment_id}/servers/{server_id}/logs",
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ServersLogsGetError> =
