...
impl GroupGroupSummary {
    pub fn new(group_id: uuid::Uuid, display_name: String, external: crate::models::GroupExternalLinks, is_developer: bool, bio: String, is_current_identity_member: bool, publicity: crate::models::GroupPublicity, member_count: i32, owner_identity_id: uuid::Uuid) -> GroupGroupSummary {
        GroupGroupSummary {
            group_id,
            display_name,
            avatar_url: None,
