...
impl CloudGameFull {
    /// A full game.
    pub fn new(game_id: uuid::Uuid, create_ts: String, name_id: String, display_name: String, developer_group_id: uuid::Uuid, total_player_count: i32, namespaces: Vec<crate::models::CloudNamespaceSummary>, versions: Vec<crate::models::CloudVersionSummary>, available_regions: Vec<crate::models::CloudRegionSummary>) -> CloudGameFull {
        CloudGameFull {
            game_id,
            create_ts,
            name_id,
