...
impl CloudBuildSummary {
    /// A build summary.
    pub fn new(build_id: uuid::Uuid, upload_id: uuid::Uuid, display_name: String, create_ts: String, content_length: i64, complete: bool, tags: ::std::collections::HashMap<String, String>) -> CloudBuildSummary {
        CloudBuildSummary {
            build_id,
            upload_id,
            display_name,
