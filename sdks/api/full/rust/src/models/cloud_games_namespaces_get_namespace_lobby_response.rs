...
impl CloudGamesNamespacesGetNamespaceLobbyResponse {
    pub fn new(lobby: crate::models::CloudLogsLobbySummary, stdout_presigned_urls: Vec<String>, stderr_presigned_urls: Vec<String>, perf_lists: Vec<crate::models::CloudSvcPerf>) -> CloudGamesNamespacesGetNamespaceLobbyResponse {
