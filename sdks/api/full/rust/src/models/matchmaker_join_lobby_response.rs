...
impl MatchmakerJoinLobbyResponse {
    pub fn new(lobby: crate::models::MatchmakerJoinLobby, ports: ::std::collections::HashMap<String, crate::models::MatchmakerJoinPort>, player: crate::models::MatchmakerJoinPlayer) -> MatchmakerJoinLobbyResponse {
