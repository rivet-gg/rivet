...
/// CloudVersionCdnCdnConfig : CDN configuration for a given version.

#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct CloudVersionCdnCdnConfig {
...
impl CloudVersionCdnCdnConfig {
	/// CDN configuration for a given version.
	pub fn new() -> CloudVersionCdnCdnConfig {
