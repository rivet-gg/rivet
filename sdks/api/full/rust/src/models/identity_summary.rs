...
impl IdentitySummary {
    /// An identity summary.
    pub fn new(identity_id: uuid::Uuid, display_name: String, account_number: i32, avatar_url: String, is_registered: bool, external: crate::models::IdentityExternalLinks, following: bool, is_following_me: bool, is_mutual_following: bool) -> IdentitySummary {
        IdentitySummary {
            identity_id,
            display_name,
            account_number,
