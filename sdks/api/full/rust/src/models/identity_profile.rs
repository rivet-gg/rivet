...
impl IdentityProfile {
    /// An identity profile.
    pub fn new(identity_id: uuid::Uuid, display_name: String, account_number: i32, avatar_url: String, is_registered: bool, external: crate::models::IdentityExternalLinks, is_admin: bool, follower_count: i64, following_count: i64, following: bool, is_following_me: bool, is_mutual_following: bool, join_ts: String, bio: String, linked_accounts: Vec<crate::models::IdentityLinkedAccount>, groups: Vec<crate::models::IdentityGroup>, games: Vec<crate::models::GameStatSummary>) -> IdentityProfile {
        IdentityProfile {
            identity_id,
            display_name,
            account_number,
