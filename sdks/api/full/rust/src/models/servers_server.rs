...
impl ServersServer {
    pub fn new(id: uuid::Uuid, environment: uuid::Uuid, datacenter: uuid::Uuid, tags: Option<serde_json::Value>, runtime: crate::models::ServersRuntime, network: crate::models::ServersNetwork, resources: crate::models::ServersResources, lifecycle: crate::models::ServersLifecycle, created_at: i64) -> ServersServer {
        ServersServer {
            id,
            environment,
            datacenter,
