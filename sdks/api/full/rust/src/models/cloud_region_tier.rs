...
impl CloudRegionTier {
    ...
    pub fn new(tier_name_id: String, rivet_cores_numerator: i32, rivet_cores_denominator: i32, cpu: i32, memory: i32, disk: i32, bandwidth: i32, price_per_second: i32) -> CloudRegionTier {
        CloudRegionTier {
            tier_name_id,
