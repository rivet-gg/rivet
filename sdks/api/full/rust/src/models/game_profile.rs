...
impl GameProfile {
    /// A game profile.
    pub fn new(game_id: uuid::Uuid, name_id: String, display_name: String, url: String, developer: crate::models::GroupGroupSummary, tags: Vec<String>, description: String, platforms: Vec<crate::models::GamePlatformLink>, recommended_groups: Vec<crate::models::GroupGroupSummary>, identity_leaderboard_categories: Vec<crate::models::GameLeaderboardCategory>, group_leaderboard_categories: Vec<crate::models::GameLeaderboardCategory>) -> GameProfile {
        GameProfile {
            game_id,
            name_id,
            display_name,
