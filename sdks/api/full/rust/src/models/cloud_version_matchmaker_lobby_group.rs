...
impl CloudVersionMatchmakerLobbyGroup {
    /// A game mode.
    pub fn new(name_id: String, regions: Vec<crate::models::CloudVersionMatchmakerLobbyGroupRegion>, max_players_normal: i32, max_players_direct: i32, max_players_party: i32, runtime: crate::models::CloudVersionMatchmakerLobbyGroupRuntime) -> CloudVersionMatchmakerLobbyGroup {
