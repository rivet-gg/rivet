...
pub struct RoutesHistoryResponse {
...
impl RoutesHistoryResponse {
    pub fn new(metric_names: Vec<String>, metric_attributes: Vec<::std::collections::HashMap<String, String>>, metric_types: Vec<String>, metric_values: Vec<Vec<f64>>) -> RoutesHistoryResponse {
