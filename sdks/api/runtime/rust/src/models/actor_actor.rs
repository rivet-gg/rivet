...
impl ActorActor {
    pub fn new(id: uuid::Uuid, region: String, tags: Option<serde_json::Value>, runtime: crate::models::ActorRuntime, network: crate::models::ActorNetwork, resources: crate::models::ActorResources, lifecycle: crate::models::ActorLifecycle, created_at: String) -> ActorActor {
        ActorActor {
            id,
            region,
            tags,
