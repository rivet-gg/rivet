...
impl ActorsGetActorMetricsResponse {
    pub fn new(actor_ids: Vec<String>, metric_names: Vec<String>, metric_attributes: Vec<::std::collections::HashMap<String, String>>, metric_types: Vec<String>, metric_values: Vec<Vec<f64>>) -> ActorsGetActorMetricsResponse {
