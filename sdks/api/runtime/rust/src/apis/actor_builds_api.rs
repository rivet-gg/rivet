...
pub async fn actor_builds_complete(configuration: &configuration::Configuration, build: &str, project: Option<&str>, environment: Option<&str>) -> Result<(), Error<ActorBuildsCompleteError>> {
...
pub async fn actor_builds_patch_tags(configuration: &configuration::Configuration, build: &str, actor_patch_build_tags_request: crate::models::ActorPatchBuildTagsRequest, project: Option<&str>, environment: Option<&str>) -> Result<serde_json::Value, Error<ActorBuildsPatchTagsError>> {
    let local_var_configuration = configuration;
...
pub async fn actor_builds_prepare(configuration: &configuration::Configuration, actor_prepare_build_request: crate::models::ActorPrepareBuildRequest, project: Option<&str>, environment: Option<&str>) -> Result<crate::models::ActorPrepareBuildResponse, Error<ActorBuildsPrepareError>> {
    let local_var_configuration = configuration;
