...
pub async fn actors_metrics_get(configuration: &configuration::Configuration, actor: &str, start: i32, end: i32, interval: i32, project: Option<&str>, environment: Option<&str>) -> Result<crate::models::ActorsGetActorMetricsResponse, Error<ActorsMetricsGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/actors/{actor}/metrics/history", local_var_configuration.base_path, actor=crate::apis::urlencode(actor));
