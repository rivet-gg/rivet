...
export class Regions {
    ...
    /**
     * @param {RivetClient.actor.ResolveRegionsRequestQuery} request
     * @param {Regions.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async resolve(
        request: RivetClient.actor.ResolveRegionsRequestQuery = {},
        requestOptions?: Regions.RequestOptions
    ): Promise<RivetClient.actor.ResolveRegionResponse> {
        const { long, lat } = request;
        const _queryParams: Record<string, string | string[] | object | object[]> = {};
        if (long != null) {
