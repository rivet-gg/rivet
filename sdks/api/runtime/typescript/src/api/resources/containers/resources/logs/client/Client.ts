...
export class Logs {
     ...
     *
     * @param {Rivet.containers.GetContainerLogsRequestQuery} request
     ...
     *
     * @example
     *     await client.containers.logs.get({
     *         project: "string",
     *         environment: "string",
     *         stream: "std_out",
     ...
     */
    public async get(
        request: Rivet.containers.GetContainerLogsRequestQuery,
        requestOptions?: Logs.RequestOptions,
    ): Promise<Rivet.containers.GetContainerLogsResponse> {
        const {
            project,
            environment,
            stream,
        ...
        _queryParams["stream"] = serializers.containers.QueryLogStream.jsonOrThrow(stream, {
            unrecognizedObjectKeys: "strip",
        });
        _queryParams["container_ids_json"] = containerIdsJson;
        if (searchText != null) {
        ...
        if (_response.ok) {
            return serializers.containers.GetContainerLogsResponse.parseOrThrow(_response.body, {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RivetTimeoutError("Timeout exceeded when calling GET /v1/containers/logs.");
            case "unknown":
                throw new errors.RivetError({
