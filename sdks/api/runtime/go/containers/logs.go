...
type GetContainerLogsRequestQuery struct {
	Project             *string        `json:"-"`
	Environment         *string        `json:"-"`
	Stream              QueryLogStream `json:"-"`
	ContainerIdsJson    string         `json:"-"`
...
type GetContainerLogsResponse struct {
	...
	ContainerIds []sdk.Id `json:"container_ids,omitempty"`
	// Sorted old to new.
	...
	ContainerIndices []int              `json:"container_indices,omitempty"`
	Watch            *sdk.WatchResponse `json:"watch,omitempty"`

	_rawJSON json.RawMessage
}

func (g *GetContainerLogsResponse) UnmarshalJSON(data []byte) error {
	type unmarshaler GetContainerLogsResponse
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*g = GetContainerLogsResponse(value)
	g._rawJSON = json.RawMessage(data)
	return nil
}

func (g *GetContainerLogsResponse) String() string {
	if len(g._rawJSON) > 0 {
