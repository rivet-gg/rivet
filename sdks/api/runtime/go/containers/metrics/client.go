...
func (c *Client) Get(ctx context.Context, container sdk.Id, request *containers.GetContainerMetricsRequestQuery) (*containers.GetContainerMetricsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := fmt.Sprintf(baseURL+"/"+"v1/containers/%v/metrics/history", container)
	...
	var response *containers.GetContainerMetricsResponse
