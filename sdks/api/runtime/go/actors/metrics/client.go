...
func (c *Client) Get(ctx context.Context, actor sdk.Id, request *actors.GetActorMetricsRequestQuery) (*actors.GetActorMetricsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := fmt.Sprintf(baseURL+"/"+"v2/actors/%v/metrics/history", actor)
