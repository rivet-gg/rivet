...
func (c *Client) Get(ctx context.Context, request *actors.GetActorMetricsRequestQuery) (*actors.GetActorMetricsResponse, error) {
	baseURL := "https://api.rivet.gg"
	if c.baseURL != "" {
		baseURL = c.baseURL
	}
	endpointURL := baseURL + "/" + "actors/metrics/history"
	...
	queryParams.Add("metrics_json", fmt.Sprintf("%v", request.MetricsJson))
	...
	var response *actors.GetActorMetricsResponse
