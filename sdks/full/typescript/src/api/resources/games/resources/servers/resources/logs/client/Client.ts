...
export class Logs {
     ...
     * @param {Rivet.games.servers.GetServerLogsRequest} request
     ...
     *
     * @example
     *     await client.games.servers.logs.getServerLogs("d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32", "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32", {
     *         stream: Rivet.games.servers.LogStream.StdOut,
    ...
    public async getServerLogs(
        gameId: string,
        serverId: string,
        request: Rivet.games.servers.GetServerLogsRequest,
        requestOptions?: Logs.RequestOptions
    ): Promise<Rivet.games.servers.GetServerLogsResponse> {
        const { stream, gameId: gameId_, watchIndex } = request;
        ...
        if (_response.ok) {
            return serializers.games.servers.GetServerLogsResponse.parseOrThrow(_response.body, {
