...
export class Servers {
     ...
     */
    public async create(
        request: Rivet.dynamicServers.CreateServerRequest,
        requestOptions?: Servers.RequestOptions
    ): Promise<Rivet.dynamicServers.CreateServerResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                "/dynamic-servers/servers"
            ),
            method: "POST",
            headers: {
            ...
            body: await serializers.dynamicServers.CreateServerRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return await serializers.dynamicServers.CreateServerResponse.parseOrThrow(_response.body, {
    ...
    public async destroy(
        serverId: string,
        request: Rivet.dynamicServers.DestroyServerRequest = {},
        requestOptions?: Servers.RequestOptions
    ): Promise<Rivet.dynamicServers.DestroyServerResponse> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                `/dynamic-servers/servers/${serverId}`
            ),
            method: "DELETE",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
        ...
        if (_response.ok) {
            return await serializers.dynamicServers.DestroyServerResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
