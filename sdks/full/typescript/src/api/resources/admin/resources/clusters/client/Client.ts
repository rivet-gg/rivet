...
export class Clusters {
    ...
    public async list(requestOptions?: Clusters.RequestOptions): Promise<Rivet.admin.clusters.ListClustersResponse> {
        ...
        if (_response.ok) {
            return await serializers.admin.clusters.ListClustersResponse.parseOrThrow(_response.body, {
    ...
    public async create(
        ...
        if (_response.ok) {
            return await serializers.admin.clusters.CreateClusterResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
