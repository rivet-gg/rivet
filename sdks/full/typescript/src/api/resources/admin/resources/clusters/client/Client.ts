...
export class Clusters {
     ...
     */
    public async list(requestOptions?: Clusters.RequestOptions): Promise<Rivet.admin.clusters.ListClustersResponse> {
        ...
        if (_response.ok) {
            return serializers.admin.clusters.ListClustersResponse.parseOrThrow(_response.body, {
     ...
     */
    public async create(
        request: Rivet.admin.clusters.CreateClusterRequest,
        requestOptions?: Clusters.RequestOptions
    ): Promise<Rivet.admin.clusters.CreateClusterResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                "/admin/clusters"
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.admin.clusters.CreateClusterRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return serializers.admin.clusters.CreateClusterResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
