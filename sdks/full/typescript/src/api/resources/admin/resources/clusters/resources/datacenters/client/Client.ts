...
export class Datacenters {
    ...
    public async list(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                ...
                `/admin/clusters/${encodeURIComponent(clusterId)}/datacenters`
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return serializers.admin.clusters.ListDatacentersResponse.parseOrThrow(_response.body, {
    ...
    public async create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.admin.clusters.CreateDatacenterRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return serializers.admin.clusters.CreateDatacenterResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
    ...
    public async update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                `/admin/clusters/${encodeURIComponent(clusterId)}/datacenters/${encodeURIComponent(datacenterId)}`
            ),
            method: "PATCH",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.admin.clusters.UpdateDatacenterRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 180000,
            maxRetries: requestOptions?.maxRetries,
