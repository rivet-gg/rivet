...
export class Builds {
    ...
    public async listGameBuilds(
    ...
    ): Promise<Rivet.cloud.games.docker.ListGameBuildsResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                `/cloud/games/${gameId}/docker/builds`
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.cloud.games.docker.ListGameBuildsResponse.parseOrThrow(_response.body, {
    ...
    public async createGameBuild(
        gameId: string,
        request: Rivet.cloud.games.docker.CreateGameBuildRequest,
        requestOptions?: Builds.RequestOptions
    ): Promise<Rivet.cloud.games.docker.CreateGameBuildResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                `/cloud/games/${gameId}/docker/builds`
        ...
        if (_response.ok) {
            return await serializers.cloud.games.docker.CreateGameBuildResponse.parseOrThrow(_response.body, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                skipValidation: true,
