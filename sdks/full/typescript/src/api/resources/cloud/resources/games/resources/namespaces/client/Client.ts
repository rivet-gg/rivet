...
export class Namespaces {
     ...
     * @throws {@link Rivet.BadRequestError}
     */
    public async createGameNamespaceTokenService(
        gameId: string,
        namespaceId: string,
        request: Rivet.cloud.games.namespaces.CreateGameNamespaceTokenServiceRequest,
        requestOptions?: Namespaces.RequestOptions
    ): Promise<Rivet.cloud.games.namespaces.CreateGameNamespaceTokenServiceResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.RivetEnvironment.Production,
                `/cloud/games/${gameId}/namespaces/${namespaceId}/tokens/service`
            ),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            ...
            contentType: "application/json",
            body: await serializers.cloud.games.namespaces.CreateGameNamespaceTokenServiceRequest.jsonOrThrow(request, {
                unrecognizedObjectKeys: "strip",
            }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 180000,
            maxRetries: requestOptions?.maxRetries,
        ...
        if (_response.ok) {
            return await serializers.cloud.games.namespaces.CreateGameNamespaceTokenServiceResponse.parseOrThrow(
                _response.body,
                {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
