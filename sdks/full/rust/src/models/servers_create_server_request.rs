...
impl ServersCreateServerRequest {
    pub fn new(datacenter: String, image: uuid::Uuid, network: crate::models::ServersCreateServerNetworkRequest, resources: crate::models::ServersResources, tags: Option<serde_json::Value>) -> ServersCreateServerRequest {
