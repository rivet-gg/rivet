...
impl CloudNamespaceFull {
    /// A full namespace.
    pub fn new(config: crate::models::CloudNamespaceConfig, create_ts: String, display_name: String, name_id: String, namespace_id: uuid::Uuid, version_id: uuid::Uuid) -> CloudNamespaceFull {
        CloudNamespaceFull {
