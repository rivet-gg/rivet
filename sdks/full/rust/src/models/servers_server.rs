...
impl ServersServer {
    pub fn new(cluster_id: uuid::Uuid, create_ts: i64, datacenter_id: uuid::Uuid, game_id: uuid::Uuid, metadata: Option<serde_json::Value>, resources: crate::models::ServersResources, runtime: crate::models::ServersRuntime, server_id: uuid::Uuid) -> ServersServer {
        ServersServer {
            cluster_id,
            create_ts,
            datacenter_id,
