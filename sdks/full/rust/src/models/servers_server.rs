...
impl ServersServer {
    pub fn new(cluster: uuid::Uuid, created_at: i64, datacenter: String, game: uuid::Uuid, id: uuid::Uuid, image: uuid::Uuid, network: crate::models::ServersNetwork, resources: crate::models::ServersResources, tags: Option<serde_json::Value>) -> ServersServer {
        ServersServer {
            arguments: None,
            cluster,
            created_at,
