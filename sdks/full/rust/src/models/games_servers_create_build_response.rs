...
pub struct GamesServersCreateBuildResponse {
...
impl GamesServersCreateBuildResponse {
    pub fn new(build_id: uuid::Uuid, upload_id: uuid::Uuid) -> GamesServersCreateBuildResponse {
