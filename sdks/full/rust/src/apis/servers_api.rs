...
pub async fn servers_create(
	...
	game_id: &str,
	environment_id: &str,
	servers_create_server_request: crate::models::ServersCreateServerRequest,
) -> Result<crate::models::ServersCreateServerResponse, Error<ServersCreateError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ServersCreateError> =
...
pub async fn servers_destroy(
	configuration: &configuration::Configuration,
	game_id: &str,
	environment_id: &str,
	server_id: &str,
	override_kill_timeout: Option<i64>,
) -> Result<serde_json::Value, Error<ServersDestroyError>> {
	let local_var_configuration = configuration;

	let local_var_client = &local_var_configuration.client;

	let local_var_uri_str = format!(
		"{}/games/{game_id}/environments/{environment_id}/servers/{server_id}",
		local_var_configuration.base_path,
		game_id = crate::apis::urlencode(game_id),
		environment_id = crate::apis::urlencode(environment_id),
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ServersDestroyError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn servers_get(
	...
	environment_id: &str,
	server_id: &str,
) -> Result<crate::models::ServersGetServerResponse, Error<ServersGetError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ServersGetError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn servers_list(
	...
	cursor: Option<&str>,
) -> Result<crate::models::ServersListServersResponse, Error<ServersListError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ServersListError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
