...
pub async fn servers_list(configuration: &configuration::Configuration, game_id: &str, tags: Option<&str>, game: Option<&str>) -> Result<crate::models::ServersListServersResponse, Error<ServersListError>> {
    let local_var_configuration = configuration;
