...
pub async fn actor_builds_complete(configuration: &configuration::Configuration, game_id: &str, environment_id: &str, build_id: &str) -> Result<(), Error<ActorBuildsCompleteError>> {
...
pub async fn actor_builds_get(configuration: &configuration::Configuration, game_id: &str, environment_id: &str, build_id: &str, tags_json: Option<&str>) -> Result<crate::models::ActorGetBuildResponse, Error<ActorBuildsGetError>> {
    let local_var_configuration = configuration;
...
/// Lists all builds of the game associated with the token used. Can be filtered by tags in the query string.
pub async fn actor_builds_list(configuration: &configuration::Configuration, game_id: &str, environment_id: &str, tags_json: Option<&str>) -> Result<crate::models::ActorListBuildsResponse, Error<ActorBuildsListError>> {
    let local_var_configuration = configuration;
...
pub async fn actor_builds_patch_tags(configuration: &configuration::Configuration, game_id: &str, environment_id: &str, build_id: &str, actor_patch_build_tags_request: crate::models::ActorPatchBuildTagsRequest) -> Result<serde_json::Value, Error<ActorBuildsPatchTagsError>> {
    let local_var_configuration = configuration;
...
pub async fn actor_builds_prepare(configuration: &configuration::Configuration, game_id: &str, environment_id: &str, actor_create_build_request: crate::models::ActorCreateBuildRequest) -> Result<crate::models::ActorCreateBuildResponse, Error<ActorBuildsPrepareError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&actor_create_build_request);
