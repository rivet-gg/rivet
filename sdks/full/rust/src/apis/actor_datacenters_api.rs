...
/// struct for typed errors of method [`actor_datacenters_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ActorDatacentersListError {
...
pub async fn actor_datacenters_list(
	configuration: &configuration::Configuration,
	game_id: Option<&str>,
	environment_id: Option<&str>,
) -> Result<crate::models::ActorListDatacentersResponse, Error<ActorDatacentersListError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ActorDatacentersListError> =
