...
pub async fn servers_logs_get_server_logs(configuration: &configuration::Configuration, game_id: &str, server_id: &str, stream: ServersLogStream, game: Option<&str>, watch_index: Option<&str>) -> Result<crate::models::ServersGetServerLogsResponse, Error<ServersLogsGetServerLogsError>> {
