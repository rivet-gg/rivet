...
pub async fn cloud_games_cdn_create_game_cdn_site(
	...
	Error<CloudGamesCdnCreateGameCdnSiteError>,
> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesCdnCreateGameCdnSiteError> =
...
pub async fn cloud_games_cdn_list_game_cdn_sites(
	...
	Error<CloudGamesCdnListGameCdnSitesError>,
> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesCdnListGameCdnSitesError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
