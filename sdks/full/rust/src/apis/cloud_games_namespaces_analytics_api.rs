...
pub async fn cloud_games_namespaces_analytics_get_analytics_matchmaker_live(
	...
	Error<CloudGamesNamespacesAnalyticsGetAnalyticsMatchmakerLiveError>,
> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesNamespacesAnalyticsGetAnalyticsMatchmakerLiveError> =
