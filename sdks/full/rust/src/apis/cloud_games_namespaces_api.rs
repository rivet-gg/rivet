...
/// struct for typed errors of method [`cloud_games_namespaces_create_game_namespace_token_service`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CloudGamesNamespacesCreateGameNamespaceTokenServiceError {
    Status400(crate::models::ErrorBody),
    Status403(crate::models::ErrorBody),
    Status404(crate::models::ErrorBody),
    Status408(crate::models::ErrorBody),
...
pub async fn cloud_games_namespaces_create_game_namespace_token_service(configuration: &configuration::Configuration, game_id: &str, namespace_id: &str, cloud_games_namespaces_create_game_namespace_token_service_request: crate::models::CloudGamesNamespacesCreateGameNamespaceTokenServiceRequest) -> Result<crate::models::CloudGamesNamespacesCreateGameNamespaceTokenServiceResponse, Error<CloudGamesNamespacesCreateGameNamespaceTokenServiceError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/cloud/games/{game_id}/namespaces/{namespace_id}/tokens/service", local_var_configuration.base_path, game_id=crate::apis::urlencode(game_id), namespace_id=crate::apis::urlencode(namespace_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&cloud_games_namespaces_create_game_namespace_token_service_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CloudGamesNamespacesCreateGameNamespaceTokenServiceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
