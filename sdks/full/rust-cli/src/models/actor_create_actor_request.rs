...
impl ActorCreateActorRequest {
    pub fn new(datacenter: uuid::Uuid, network: crate::models::ActorCreateActorNetworkRequest, resources: crate::models::ActorResources, runtime: crate::models::ActorCreateActorRuntimeRequest, tags: Option<serde_json::Value>) -> ActorCreateActorRequest {
