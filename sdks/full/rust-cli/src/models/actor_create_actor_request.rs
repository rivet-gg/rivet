...
impl ActorCreateActorRequest {
    pub fn new(network: crate::models::ActorCreateActorNetworkRequest, region: String, resources: crate::models::ActorResources, runtime: crate::models::ActorCreateActorRuntimeRequest, tags: Option<serde_json::Value>) -> ActorCreateActorRequest {
