...
pub struct ActorCreateBuildRequest {
...
impl ActorCreateBuildRequest {
    pub fn new(image_file: crate::models::UploadPrepareFile, image_tag: String, name: String) -> ActorCreateBuildRequest {
