...
pub enum ServersGameGuardProtocol {
    #[serde(rename = "http")]
    Http,
    #[serde(rename = "https")]
    Https,
...
impl ToString for ServersGameGuardProtocol {
...
impl Default for ServersGameGuardProtocol {
    fn default() -> ServersGameGuardProtocol {
        Self::Http
    }
}
