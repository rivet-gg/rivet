...
pub struct AdminClustersPoolUpdate {
...
impl AdminClustersPoolUpdate {
    pub fn new(hardware: Vec<crate::models::AdminClustersHardware>, pool_type: crate::models::AdminClustersPoolType) -> AdminClustersPoolUpdate {
