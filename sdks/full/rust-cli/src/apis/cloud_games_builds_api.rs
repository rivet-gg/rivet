...
pub async fn cloud_games_builds_create_game_build(configuration: &configuration::Configuration, game_id: &str, cloud_games_create_game_build_request: crate::models::CloudGamesCreateGameBuildRequest) -> Result<crate::models::CloudGamesCreateGameBuildResponse, Error<CloudGamesBuildsCreateGameBuildError>> {
...
pub async fn cloud_games_builds_list_game_builds(configuration: &configuration::Configuration, game_id: &str) -> Result<crate::models::CloudGamesListGameBuildsResponse, Error<CloudGamesBuildsListGameBuildsError>> {
    let local_var_configuration = configuration;
