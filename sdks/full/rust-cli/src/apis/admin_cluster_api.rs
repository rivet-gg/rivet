...
/// struct for typed errors of method [`admin_cluster_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AdminClusterCreateError {
...
pub async fn admin_cluster_create(configuration: &configuration::Configuration, admin_cluster_create_request: crate::models::AdminClusterCreateRequest) -> Result<crate::models::AdminClusterCreateResponse, Error<AdminClusterCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/cluster/create", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&admin_cluster_create_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AdminClusterCreateError> = serde_json::from_str(&local_var_content).ok();
