...
pub async fn admin_clusters_create(configuration: &configuration::Configuration, admin_clusters_create_cluster_request: crate::models::AdminClustersCreateClusterRequest) -> Result<crate::models::AdminClustersCreateClusterResponse, Error<AdminClustersCreateError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&admin_clusters_create_cluster_request);
...
/// Get clusters
pub async fn admin_clusters_list(configuration: &configuration::Configuration, ) -> Result<crate::models::AdminClustersListClustersResponse, Error<AdminClustersListError>> {
    let local_var_configuration = configuration;
