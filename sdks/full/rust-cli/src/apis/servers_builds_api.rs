...
pub async fn servers_builds_complete_build(configuration: &configuration::Configuration, upload_id: &str) -> Result<(), Error<ServersBuildsCompleteBuildError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/servers/uploads/{upload_id}/complete", local_var_configuration.base_path, upload_id=crate::apis::urlencode(upload_id));
...
pub async fn servers_builds_list_builds(configuration: &configuration::Configuration, tags: Option<&str>) -> Result<crate::models::ServersListBuildsResponse, Error<ServersBuildsListBuildsError>> {
    ...
    let local_var_uri_str = format!("{}/servers/builds", local_var_configuration.base_path);
...
pub async fn servers_builds_prepare_build(configuration: &configuration::Configuration, servers_create_build_request: crate::models::ServersCreateBuildRequest) -> Result<crate::models::ServersCreateBuildResponse, Error<ServersBuildsPrepareBuildError>> {
    let local_var_configuration = configuration;
