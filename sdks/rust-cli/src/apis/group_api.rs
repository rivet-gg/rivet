...
pub async fn group_ban_identity(
	configuration: &configuration::Configuration,
	group_id: &str,
	identity_id: &str,
) -> Result<(), Error<GroupBanIdentityError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupBanIdentityError> =
...
pub async fn group_complete_avatar_upload(
	configuration: &configuration::Configuration,
	group_id: &str,
	upload_id: &str,
) -> Result<(), Error<GroupCompleteAvatarUploadError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupCompleteAvatarUploadError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_create(
	configuration: &configuration::Configuration,
	group_create_request: crate::models::GroupCreateRequest,
) -> Result<crate::models::GroupCreateResponse, Error<GroupCreateError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupCreateError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_get_bans(
	configuration: &configuration::Configuration,
	group_id: &str,
	anchor: Option<&str>,
	count: Option<f64>,
	watch_index: Option<&str>,
) -> Result<crate::models::GroupGetBansResponse, Error<GroupGetBansError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupGetBansError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_get_join_requests(
	configuration: &configuration::Configuration,
	group_id: &str,
	anchor: Option<&str>,
	count: Option<f64>,
	watch_index: Option<&str>,
) -> Result<crate::models::GroupGetJoinRequestsResponse, Error<GroupGetJoinRequestsError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupGetJoinRequestsError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_get_members(
	configuration: &configuration::Configuration,
	group_id: &str,
	anchor: Option<&str>,
	count: Option<f64>,
	watch_index: Option<&str>,
) -> Result<crate::models::GroupGetMembersResponse, Error<GroupGetMembersError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupGetMembersError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_get_profile(
	configuration: &configuration::Configuration,
	group_id: &str,
	watch_index: Option<&str>,
) -> Result<crate::models::GroupGetProfileResponse, Error<GroupGetProfileError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupGetProfileError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_get_summary(
	configuration: &configuration::Configuration,
	group_id: &str,
) -> Result<crate::models::GroupGetSummaryResponse, Error<GroupGetSummaryError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupGetSummaryError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_kick_member(
	configuration: &configuration::Configuration,
	group_id: &str,
	identity_id: &str,
) -> Result<(), Error<GroupKickMemberError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupKickMemberError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_leave(
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupLeaveError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_list_suggested(
	configuration: &configuration::Configuration,
	watch_index: Option<&str>,
) -> Result<crate::models::GroupListSuggestedResponse, Error<GroupListSuggestedError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupListSuggestedError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_prepare_avatar_upload(
	configuration: &configuration::Configuration,
	group_prepare_avatar_upload_request: crate::models::GroupPrepareAvatarUploadRequest,
) -> Result<crate::models::GroupPrepareAvatarUploadResponse, Error<GroupPrepareAvatarUploadError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupPrepareAvatarUploadError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_search(
	...
	anchor: Option<&str>,
	limit: Option<f64>,
) -> Result<crate::models::GroupSearchResponse, Error<GroupSearchError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupSearchError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_transfer_ownership(
	configuration: &configuration::Configuration,
	group_id: &str,
	group_transfer_ownership_request: crate::models::GroupTransferOwnershipRequest,
) -> Result<(), Error<GroupTransferOwnershipError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupTransferOwnershipError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_unban_identity(
	configuration: &configuration::Configuration,
	group_id: &str,
	identity_id: &str,
) -> Result<(), Error<GroupUnbanIdentityError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupUnbanIdentityError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_update_profile(
	configuration: &configuration::Configuration,
	group_id: &str,
	group_update_profile_request: crate::models::GroupUpdateProfileRequest,
) -> Result<(), Error<GroupUpdateProfileError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupUpdateProfileError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn group_validate_profile(
	configuration: &configuration::Configuration,
	group_validate_profile_request: crate::models::GroupValidateProfileRequest,
) -> Result<crate::models::GroupValidateProfileResponse, Error<GroupValidateProfileError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<GroupValidateProfileError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
