...
/// Creates a new game.
pub async fn cloud_games_games_create_game(
	configuration: &configuration::Configuration,
	cloud_games_create_game_request: crate::models::CloudGamesCreateGameRequest,
) -> Result<crate::models::CloudGamesCreateGameResponse, Error<CloudGamesGamesCreateGameError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesCreateGameError> =
...
pub async fn cloud_games_games_game_banner_upload_complete(
	configuration: &configuration::Configuration,
	game_id: &str,
	upload_id: &str,
) -> Result<(), Error<CloudGamesGamesGameBannerUploadCompleteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesGameBannerUploadCompleteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn cloud_games_games_game_banner_upload_prepare(
	configuration: &configuration::Configuration,
	game_id: &str,
	...
	Error<CloudGamesGamesGameBannerUploadPrepareError>,
> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesGameBannerUploadPrepareError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn cloud_games_games_game_logo_upload_complete(
	configuration: &configuration::Configuration,
	game_id: &str,
	upload_id: &str,
) -> Result<(), Error<CloudGamesGamesGameLogoUploadCompleteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesGameLogoUploadCompleteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn cloud_games_games_game_logo_upload_prepare(
	configuration: &configuration::Configuration,
	game_id: &str,
	...
	Error<CloudGamesGamesGameLogoUploadPrepareError>,
> {
	let local_var_configuration = configuration;
...
pub async fn cloud_games_games_get_game_by_id(
	configuration: &configuration::Configuration,
	game_id: &str,
	watch_index: Option<&str>,
) -> Result<crate::models::CloudGamesGetGameByIdResponse, Error<CloudGamesGamesGetGameByIdError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesGetGameByIdError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn cloud_games_games_get_games(
	configuration: &configuration::Configuration,
	watch_index: Option<&str>,
) -> Result<crate::models::CloudGamesGetGamesResponse, Error<CloudGamesGamesGetGamesError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesGetGamesError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn cloud_games_games_validate_game(
	configuration: &configuration::Configuration,
	cloud_games_validate_game_request: crate::models::CloudGamesValidateGameRequest,
) -> Result<crate::models::CloudGamesValidateGameResponse, Error<CloudGamesGamesValidateGameError>>
{
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<CloudGamesGamesValidateGameError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
