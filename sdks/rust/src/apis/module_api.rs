...
pub async fn module_call(
	...
	module: &str,
	script: &str,
	module_call_request: crate::models::ModuleCallRequest,
	origin: Option<&str>,
) -> Result<crate::models::ModuleCallResponse, Error<ModuleCallError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<ModuleCallError> =
