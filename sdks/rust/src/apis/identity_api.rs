...
pub async fn identity_follow(
	configuration: &configuration::Configuration,
	identity_id: &str,
) -> Result<(), Error<IdentityFollowError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityFollowError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_ignore_recent_follower(
	configuration: &configuration::Configuration,
	identity_id: &str,
) -> Result<(), Error<IdentityIgnoreRecentFollowerError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityIgnoreRecentFollowerError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_list_followers(
	configuration: &configuration::Configuration,
	identity_id: &str,
	anchor: Option<&str>,
	limit: Option<&str>,
) -> Result<crate::models::IdentityListFollowersResponse, Error<IdentityListFollowersError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityListFollowersError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_list_following(
	configuration: &configuration::Configuration,
	identity_id: &str,
	anchor: Option<&str>,
	limit: Option<&str>,
) -> Result<crate::models::IdentityListFollowingResponse, Error<IdentityListFollowingError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityListFollowingError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_list_friends(
	configuration: &configuration::Configuration,
	anchor: Option<&str>,
	limit: Option<&str>,
) -> Result<crate::models::IdentityListFriendsResponse, Error<IdentityListFriendsError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityListFriendsError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_list_mutual_friends(
	configuration: &configuration::Configuration,
	identity_id: &str,
	anchor: Option<&str>,
	limit: Option<&str>,
) -> Result<crate::models::IdentityListMutualFriendsResponse, Error<IdentityListMutualFriendsError>>
{
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityListMutualFriendsError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_list_recent_followers(
	configuration: &configuration::Configuration,
	count: Option<i32>,
	watch_index: Option<&str>,
) -> Result<
	crate::models::IdentityListRecentFollowersResponse,
	Error<IdentityListRecentFollowersError>,
> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityListRecentFollowersError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_report(
	configuration: &configuration::Configuration,
	identity_id: &str,
	identity_report_request: crate::models::IdentityReportRequest,
) -> Result<(), Error<IdentityReportError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityReportError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_search(
	configuration: &configuration::Configuration,
	query: &str,
	anchor: Option<&str>,
	limit: Option<i32>,
) -> Result<crate::models::IdentitySearchResponse, Error<IdentitySearchError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentitySearchError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_unfollow(
	configuration: &configuration::Configuration,
	identity_id: &str,
) -> Result<(), Error<IdentityUnfollowError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityUnfollowError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
