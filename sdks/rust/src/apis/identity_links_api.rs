...
pub async fn identity_links_cancel(
	configuration: &configuration::Configuration,
	identity_cancel_game_link_request: crate::models::IdentityCancelGameLinkRequest,
) -> Result<(), Error<IdentityLinksCancelError>> {
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityLinksCancelError> =
...
pub async fn identity_links_complete(
	configuration: &configuration::Configuration,
	identity_complete_game_link_request: crate::models::IdentityCompleteGameLinkRequest,
) -> Result<(), Error<IdentityLinksCompleteError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityLinksCompleteError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_links_get(
	configuration: &configuration::Configuration,
	identity_link_token: &str,
	watch_index: Option<&str>,
) -> Result<crate::models::IdentityGetGameLinkResponse, Error<IdentityLinksGetError>> {
	let local_var_configuration = configuration;
	...
	local_var_req_builder =
		local_var_req_builder.query(&[("identity_link_token", &identity_link_token.to_string())]);
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityLinksGetError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
...
pub async fn identity_links_prepare(
	configuration: &configuration::Configuration,
) -> Result<crate::models::IdentityPrepareGameLinkResponse, Error<IdentityLinksPrepareError>> {
	let local_var_configuration = configuration;
	...
	if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
		...
		let local_var_entity: Option<IdentityLinksPrepareError> =
			serde_json::from_str(&local_var_content).ok();
		let local_var_error = ResponseContent {
			status: local_var_status,
			content: local_var_content,
