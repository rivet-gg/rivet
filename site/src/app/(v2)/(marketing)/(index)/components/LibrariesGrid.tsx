...
import { Icon, faShapes, faSquareQuestion, faArrowRight } from "@rivet-gg/icons";
          ...
          <div className="px-6 mt-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-white/30">
                Replaces <span className="text-white/60 font-medium">Durable Objects</span>, <span className="text-white/60 font-medium">Orleans</span>, or <span className="text-white/60 font-medium">Akka</span>
              </p>
            </div>
          </div>
        </div>
