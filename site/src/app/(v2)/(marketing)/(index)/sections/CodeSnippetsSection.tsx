...
export function CodeSnippetsSection() {
	...
	const examples = [
		...
		{
			id: "crdt" as ExampleTab,
			icon: "file-pen",
			title: "Collaborative Document (CRDT)",
		},
		{ id: "chat" as ExampleTab, icon: "message", title: "Chat Room" },
		{
			id: "database" as ExampleTab,
			icon: "database",
			title: "Per-User Databases",
		},
		{ id: "rate" as ExampleTab, icon: "gauge-high", title: "Rate Limiter" },
		{
			id: "stream" as ExampleTab,
			icon: "wave-sine",
			title: "Stream Processing",
		},
		{
			id: "game" as ExampleTab,
			icon: "gamepad",
...
export default aiAgent;`
				: `import { actor, drizzle } from "rivetkit";
					...
					<div className="border-r border-white/10">
						...
						<div className="p-6">
							<pre className="text-sm text-white/80 overflow-auto max-h-96 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/20">
								<code>
									{getActorCode(activeExample, activeState)}
								</code>
							</pre>
						</div>
					</div>
