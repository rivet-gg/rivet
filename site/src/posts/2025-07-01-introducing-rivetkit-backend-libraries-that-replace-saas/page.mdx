...
See the [authentication documentation](/docs/general/authentication) for more details.
...
See the new [actor handles documentation](/docs/actors/communicating-with-actors).
...
Read more about [creating actors](/docs/actors/communicating-with-actors).
