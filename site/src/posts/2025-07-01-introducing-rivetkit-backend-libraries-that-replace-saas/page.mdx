...
See the [auth documentation](https://rivet.gg/docs/rivetkit/auth) for more details.

### Better Auth Integration

See the [RivetKit + Better Auth integration](https://rivet.gg/docs/rivetkit/integrations/better-auth).
...
See the new [actor handles documentation](https://rivet.gg/docs/rivetkit/actors/handles).
...
Read more about [creating actors](https://rivet.gg/docs/rivetkit/actors/creating).
...
Read the new [connections documentation](https://rivet.gg/docs/rivetkit/actors/connections).
...
RivetKit now provides an OpenAPI spec to integrate your own clients. Read the [specification documentation](https://rivet.gg/docs/rivetkit/openapi) and see the full [openapi.json](https://rivet.gg/docs/rivetkit/openapi.json).
