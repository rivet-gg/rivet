...
In this post, I'll share how we structure our documentation for [ActorCore](https://actorcore.org) to make it easy for AI-powered tools to understand and use. 
...
[Checkout how we do it for ActorCore](https://actorcore.org/llm/prompt)
