...
Cloudflare Containers is currently [capped at 40 GB of RAM and 20 vCPUs per account](https://fd6d4d33.preview.developers.cloudflare.com/containers/platform-details/#limits) while in beta. Containers can be configured with a [maximum of 1/2 CPU core and 4 GB of RAM per container](https://fd6d4d33.preview.developers.cloudflare.com/containers/platform-details/#instance-types).
