...
Rivet can run non-durable actors and use the traditional actor model, if needed. This is a core part of how Open Game Backend works. The matchmaker actor handles the lifecycle of game server actors itself.
