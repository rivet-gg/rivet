...
Actors store data separately by design, so combining data from multiple actors works differently than traditional databases. This pattern is similar to patterns you'll see in other databases like Cassandra, DynamoDB, and ClickHouse.
