...
// https :https://framerusercontent.com/modules/l6yIFqJiKpzgjIjYLDe8/RiUbeIOTACkJXyxf1sof/codemirror_legacy_modes_mode_perl.js
...
function tokenPerl(stream, state,) {
  ...
  if (/[$@%]/.test(ch,)) {
    var p = stream.pos;
    if (
      stream.eat('^',) && stream.eat(/[A-Z]/,) || !/[@$%&]/.test(look(stream, -2,),) && stream.eat(/[=|\\\-#?@;:&`~\^!\[\]*'"$+.,\/<>()]/,)
    ) {
