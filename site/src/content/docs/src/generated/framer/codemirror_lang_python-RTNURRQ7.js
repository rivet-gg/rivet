// @ts-nocheck
/* eslint-disable */
import { completeFromList, ifNotIn, snippetCompletion, } from './chunk-B3PJI36V.js';
import {
  ContextTracker,
  delimitedIndent,
  ExternalTokenizer,
...
// https :https://framerusercontent.com/modules/EjGlVHogpfm3jPPe6dpv/ksfEYmQRgZtQxtsxsQOu/lezer_python.js
var printKeyword = 1;
var indent = 196;
var dedent = 197;
var newline$1 = 198;
...
// https :https://framerusercontent.com/modules/NlaGw745MKw3pDtavCDw/bJdmzV5wKmaoaOZ34lWV/codemirror_lang_python.js
...
var gatherCompletions = {
  ...
  ImportStatement(_node, def,) {
    ...
    for (let ch = node.getChild('import',); ch; ch = ch.nextSibling) {
      if (ch.name == 'VariableName' && ((_b = ch.nextSibling) === null || _b === void 0 ? void 0 : _b.name) != 'as') {def(
          ch,
          isFrom ? 'variable' : 'namespace',
        );}
    }
  },
...
var snippets = [
  ...
  /* @__PURE__ */ snippetCompletion('import ${module}', { label: 'import', detail: 'statement', type: 'keyword', },),
  /* @__PURE__ */ snippetCompletion('from ${module} import ${names}', { label: 'from', detail: 'import', type: 'keyword', },),
];
...
function indentBody(context, node,) {
  ...
  if (
    /^\s*($|#)/.test(line.text,) && context.node.to < to + 100 && !/\S/.test(context.state.sliceDoc(to, context.node.to,),) &&
...
var __FramerMetadata__ = {
  'exports': {
    'python': { 'type': 'function', 'annotations': { 'framerContractVersion': '1', }, },
    'localCompletionSource': { 'type': 'function', 'annotations': { 'framerContractVersion': '1', }, },
    'pythonLanguage': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'globalCompletion': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
