...
// https :https://framerusercontent.com/modules/mVgptLxlny3aCNt13jWX/UBsF1xq4TdJtf65SHBJZ/codemirror_legacy_modes_mode_clike.js
...
function clike(parserConfig,) {
  ...
  return {
    ...
    token: function (stream, state,) {
      ...
      if (curPunc == ';' || curPunc == ':' || curPunc == ',' && stream.match(/^\s*(?:\/\/.*)?$/, false,)) {while (
          state.context.type == 'statement'
        ) popContext(state,);} else if (curPunc == '{') pushContext(state, stream.column(), '}',);
        ...
        indentStatements &&
        ((ctx.type == '}' || ctx.type == 'top') && curPunc != ';' || ctx.type == 'statement' && curPunc == 'newstatement')
      ) {
...
var cpp = clike({
  ...
  hooks: {
    ...
    token: function (stream, state, style,) {
      if (
        style == 'variable' && stream.peek() == '(' && (state.prevToken == ';' || state.prevToken == null || state.prevToken == '}') &&
  ...
  hooks: {
    ...
    indent: function (state, ctx, textAfter, indentUnit,) {
      ...
      if (
        ...
        state.prevToken == 'variable' && firstChar == '.' || (state.prevToken == '}' || state.prevToken == ')') && firstChar == '.'
...
var __FramerMetadata__ = {
  'exports': {
    ...
    'shader': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'clike': { 'type': 'function', 'annotations': { 'framerContractVersion': '1', }, },
    'dart': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'java': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'csharp': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'c': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'objectiveC': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'kotlin': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'ceylon': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'squirrel': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'cpp': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'objectiveCpp': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    'scala': { 'type': 'variable', 'annotations': { 'framerContractVersion': '1', }, },
    '__FramerMetadata__': { 'type': 'variable', },
  },
};
export { __FramerMetadata__, c, ceylon, clike, cpp, csharp, dart, java, kotlin, nesC, objectiveC, objectiveCpp, scala, shader, squirrel, };
