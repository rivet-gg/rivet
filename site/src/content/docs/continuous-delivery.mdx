...
1. Set up your application using one of the following guides:
   - [JavaScript Runtime](/docs/javascript-runtime) - For JavaScript applications
   - [Container Runtime](/docs/container-runtime) - For Docker containers
...
4. Under the "Builds" tab, you should see your latest deployment with the commit SHA included in the tags
