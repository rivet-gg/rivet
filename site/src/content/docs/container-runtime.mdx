...
<Note title="Ports & environment variables will be passed via the Rivet API">
	We'll pass the prots & env vars used in the Dockerfile in _Step 3_. Read more in the API docs for [actors.create](/docs/api/actors/create).
</Note>
