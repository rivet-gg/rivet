...
[`client.get(tags)`](https://jsr.io/@rivet-gg/actor-client/doc/~/Client.prototype.get) attempts to find an existing actor matching the provided tags. If no matching actor is found, it creates a new one with those tags.
