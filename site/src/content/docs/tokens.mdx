...
Rivet offers a `rivet shell` command that will auto-create a service token & pouplate common environment variables for executing commands that depend on tokens.
