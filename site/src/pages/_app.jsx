    ...
    <>
      <Providers>
        <Head>
          ...
          <meta name='twitter:image:alt' content='Rivet - Run and scale realtime applications' />
          ...
          {!pathname.startsWith('/blog/') && (
            <>
              ...
              <meta property='og:image:alt' content='Rivet - Run and scale realtime applications' />
