...
export function EnvTokenClient() {
	return (
		<Info>
			<p>
				In development,&nbsp;<code>RIVET_TOKEN</code> will use the development
				token generated by <code>rivet run</code>. In production,&nbsp;
				<code>RIVET_TOKEN</code> will be automatically added by the CDN.
			</p>
...
export function EnvTokenServer() {
	return (
		<Info>
			<p>
				In development, <code>RIVET_TOKEN</code> will use the development token
				generated by <code>rivet run</code>. In production,&nbsp;
				<code>RIVET_TOKEN</code> is automatically added to your environment by
				Rivet.
			</p>
...
export function PreRivetBranch() {
	return (
		<Info>
			<p>
				The <code>pre-rivet</code> branch contains the source code of this
				project without Rivet implemented, in contrast to the <code>main</code>{" "}
				branch. View these side by side to get a good picture of what it takes
				to integrate Rivet for your game.
			</p>
		</Info>
	);
}
	...
	return (
		<Accordion title="Can I automate this with APIs?">
			<p>
				...
				<Link href="/docs/general/concepts/token-types#cloud">cloud token</Link>
			...
			<p>
				The Cloud REST API is documented <Link href="/docs/cloud">here</Link>.
		...
		<Accordion title="Unfamiliar with Dockerfiles?">
			<ul>
				...
				<li>
					...
					will teach you how to write your own <code>Dockerfile</code> quickly
				</li>
				<li>
					Join our <a href="https://discord.gg/BG2vqsJczH">Discord</a> and
					we&apos;ll write your <code>Dockerfile</code> for you!
				</li>
			</ul>
		</Accordion>
	);
