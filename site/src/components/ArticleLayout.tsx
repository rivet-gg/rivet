	...
	return (
		<>
			<aside className="mx-auto w-full max-w-3xl flex-1 xl:max-w-aside xl:pb-8">
				<div className="mt-8">
					<p className="mb-3 mt-0  font-sans text-xs font-semibold text-white">
						Posted by
					</p>
					{/* Author */}
					<div className="relative flex items-center gap-x-3">
						...
						/>
						<div>
							<div className="text-md font-semibold text-cream-100">
								{info.author.name}
							</div>
				...
				<p className="mt-6 hidden font-sans text-xs font-semibold text-white xl:block">
					Other articles
				</p>
			...
			<Prose
				as="article"
				className="order-2 mx-auto max-w-3xl flex-1 pb-8"
			>
				<ArticleHeader {...info} />
				{children}
			</Prose>
