...
pub async fn create(
	ctx: Ctx<Auth>,
	body: models::DynamicServersCreateServerRequest,
) -> GlobalResult<models::DynamicServersCreateServerResponse> {
	...
	Ok(models::DynamicServersCreateServerResponse {
...
pub async fn destroy(
	...
	server_id: Uuid,
	query: DeleteQuery,
) -> GlobalResult<models::DynamicServersDestroyServerResponse> {
	...
	Ok(models::DynamicServersDestroyServerResponse {
