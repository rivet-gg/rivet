...
impl From<backend::ds::GameGuardProtocol> for ProxyProtocol {
	fn from(protocol: backend::ds::GameGuardProtocol) -> Self {
		match protocol {
			backend::ds::GameGuardProtocol::Http => Self::Http,
			backend::ds::GameGuardProtocol::Https => Self::Https,
			backend::ds::GameGuardProtocol::Tcp => Self::Tcp,
			backend::ds::GameGuardProtocol::TcpTls => Self::TcpTls,
			backend::ds::GameGuardProtocol::Udp => Self::Udp,
		}
	}
}
