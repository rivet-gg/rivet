  ...
  return (
    <div className='my-16 xl:max-w-none'>
      ...
      <div className='not-prose mt-4 grid grid-cols-1 gap-8 border-t border-charcole-900/5 pt-10 dark:border-white/5 sm:grid-cols-2 xl:grid-cols-4'>
        {guides.map(guide => (
          <div key={guide.href}>
            <h3 className='text-sm font-semibold text-charcole-900 dark:text-white'>{guide.name}</h3>
            <p className='mt-1 text-sm text-charcole-600 dark:text-cream-400'>{guide.description}</p>
            <p className='mt-4'>
